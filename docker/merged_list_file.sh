...
0 0,12 * * * sleep $((RANDOM % $RANDOM_DELAY_MAX)); node /scripts/jd_xtg.js |ts >> /scripts/logs/jd_xtg.log 2>&1
#5G超级盲盒 活动时间：2021-03-19到2021-04-30
0 0,1-23/4 * * * sleep $((RANDOM % $RANDOM_DELAY_MAX)); node /scripts/jd_mohe.js |ts >> /scripts/logs/jd_mohe.log 2>&1
